...
exports.createTables1678321251644 = void 0;
class createTables1678321251644 {
    constructor() {
        this.name = 'createTables1678321251644';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`CREATE TABLE "photos" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "urlImage" character varying(300) NOT NULL, "imageGaleryId" uuid, CONSTRAINT "PK_5220c45b8e32d49d767b9b3d725" PRIMARY KEY ("id"))`);
            yield queryRunner.query(`CREATE TABLE "image_galeries" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "PK_04b5e4fd423926b29d5cd338996" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`ALTER TABLE "photos" ADD CONSTRAINT "FK_e53cef540b87c278c4b9a2134cb" FOREIGN KEY ("imageGaleryId") REFERENCES "image_galeries"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            yield queryRunner.query(`ALTER TABLE "vehicles" ADD CONSTRAINT "FK_c8a353e9281bd2da8badd9e08ea" FOREIGN KEY ("imageGaleryId") REFERENCES "image_galeries"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE "vehicles" DROP CONSTRAINT "FK_c8a353e9281bd2da8badd9e08ea"`);
            yield queryRunner.query(`ALTER TABLE "photos" DROP CONSTRAINT "FK_e53cef540b87c278c4b9a2134cb"`);
...
exports.createTables1678321251644 = createTables1678321251644;
